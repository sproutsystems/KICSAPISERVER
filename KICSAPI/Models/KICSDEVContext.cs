...
namespace KICSAPI.Models
{
    ...
    {
        public KICSDEVContext()
        {
        }

        public KICSDEVContext(DbContextOptions<KICSDEVContext> options)
            : base(options)
        {
        }
...
Congratulations again and thank you for supporting {companyDisplayName}!')");
            ...
            modelBuilder.Entity<Ktixkioskorder>(entity =>
            {
                ...
                entity.Property(e => e.TotalCostOfKioskItems).HasMaxLength(10);
            ...
            modelBuilder.Entity<Ktixmasterpaymenttype>(entity =>
            {
                ...
                entity.Property(e => e.KtixMasterPaymentTypeId).ValueGeneratedNever();
